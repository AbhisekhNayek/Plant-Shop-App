...
const Footer = () => {
  return (
    <footer className="bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]">
      <div className="max-w-[1490px] mx-auto px-10 py-[120px]">
          ...
          <div className="w-full xl:w-auto flex flex-col items-center xl:items-start">
            ...
            <div className="relative w-full xs:w-[380px] xl:w-[320px] mt-11">
              <input
                type="text"
                placeholder="Email"
                className="rounded-full w-full pl-6 pr-[140px] py-4 bg-primary outline-none text-white 
                text-base xs:text-lg placeholder-white"
              />
              <button
                className="absolute top-2/4 -translate-y-2/4 right-3 
                bg-[linear-gradient(90deg,_#2AF598_0%,_#009EFD_100%)] px-6 py-2.5 rounded-full 
        ...
        <h6 className="text-white text-center text-base lg:text-lg">
          &copy; Plant Shop - All rights reserved
        </h6>
      </div>
    </footer>
  );
